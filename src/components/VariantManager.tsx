...
export function VariantManager({ variants, onChange, attributeLabels }: VariantManagerProps) {
  function addVariant() {
          ...
          <CardContent className="pt-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input value={v.sku} onChange={e => updateVariant(i, 'sku', e.target.value)} placeholder="VAR-001" className="h-8 text-sm" />
              </div>
              <div>
